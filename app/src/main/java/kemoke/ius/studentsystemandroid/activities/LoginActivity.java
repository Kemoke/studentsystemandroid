...
import static kemoke.ius.studentsystemandroid.api.HttpApi.LoginApi;
...
public class LoginActivity extends AppCompatActivity implements Callback<TokenJson>, TextView.OnEditorActionListener {
    ...
    public void onLoginClick() {
        LoginApi().login(loginEmail.getText().toString(), loginPassword.getText().toString()).enqueue(this);
